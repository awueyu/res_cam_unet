...
class Unet(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        # features = [128, 128, 128, 128, 128, 256]
        ...
        self.up6 = nn.ConvTranspose2d(features[4], features[3], 2, stride=2)
        self.conv6 = DoubleConv(features[4], features[3])

        self.up7 = nn.ConvTranspose2d(features[3], features[2], 2, stride=2)
        self.conv7 = DoubleConv(features[3], features[2])
        self.up8 = nn.ConvTranspose2d(features[2], features[1], 2, stride=2)
        self.conv8 = DoubleConv(features[2], features[1])
        self.up9 = nn.ConvTranspose2d(features[1], features[0], 2, stride=2)
        self.conv9 = DoubleConv(features[1], features[0])
        self.conv10 = nn.Conv2d(features[0], out_ch, 1)
